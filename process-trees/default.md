# Default ai-driven-sdlc Process Tree
...
The Process Tree is the authoritative execution map of ai-driven-sdlc.
...
The Process Tree is simple Markdown. Repository placement must never be inferred
from convention alone.

## Process Tree Node Contract
...
A future agent must update `PROCESS_TREE.md` whenever:
...
The Process Tree is the canonical source of truth for repository placement.
Repository placement must never be inferred from convention alone.

## Process Tree Validation Rules
